...
def parse(xlsx_path: str, db_conn: sqlite3.Connection) -> int:
    ...
    with db_conn:
        ...
        # source_files row — match by (filename, sha256); fall back to sha256
        # alone so a scraper-renamed-but-identical file dedups correctly
