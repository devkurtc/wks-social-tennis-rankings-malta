# Nexia BT Christmas Junior Open 2014

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2014
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=34](https://www.vltc.com.mt/tournament.aspx?id=34)
**Extraction method:** HTTP scrape — `tournament.aspx?id=34` + Google Sheets `export?format=xlsx`
