# Wilson Autumn Team Tournament 2014

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2014
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=32](https://www.vltc.com.mt/tournament.aspx?id=32)
**Extraction method:** HTTP scrape — `tournament.aspx?id=32` + Google Sheets `export?format=xlsx`
