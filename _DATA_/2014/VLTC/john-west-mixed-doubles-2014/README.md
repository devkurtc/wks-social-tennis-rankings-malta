# John West Mixed Doubles 2014

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2014
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=31](https://www.vltc.com.mt/tournament.aspx?id=31)
**Extraction method:** HTTP scrape — `tournament.aspx?id=31` + Google Sheets `export?format=xlsx`
