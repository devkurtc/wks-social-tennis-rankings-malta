# San Michel Junior Open 2014

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2014
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=33](https://www.vltc.com.mt/tournament.aspx?id=33)
**Extraction method:** HTTP scrape — `tournament.aspx?id=33` + Google Sheets `export?format=xlsx`
