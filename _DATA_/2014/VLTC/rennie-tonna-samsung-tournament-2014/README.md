# Rennie Tonna Samsung Tournament 2014

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2014
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=29](https://www.vltc.com.mt/tournament.aspx?id=29)
**Extraction method:** HTTP scrape — `tournament.aspx?id=29` + Google Sheets `export?format=xlsx`
