...
**Year:** 2019
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=86](https://www.vltc.com.mt/tournament.aspx?id=86)
**Extraction method:** HTTP scrape — `tournament.aspx?id=86` + Google Sheets `export?format=xlsx`
