# San Michel Junior T'ment 2019

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2019
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=89](https://www.vltc.com.mt/tournament.aspx?id=89)
**Extraction method:** HTTP scrape — `tournament.aspx?id=89` + Google Sheets `export?format=xlsx`
