# San Michel Team Tournament 2012

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2012
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=6](https://www.vltc.com.mt/tournament.aspx?id=6)
**Extraction method:** HTTP scrape — `tournament.aspx?id=6` + Google Sheets `export?format=xlsx`
