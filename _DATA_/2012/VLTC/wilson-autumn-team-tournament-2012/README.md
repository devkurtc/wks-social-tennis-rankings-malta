# Wilson Autumn Team Tournament 2012

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2012
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=3](https://www.vltc.com.mt/tournament.aspx?id=3)
**Extraction method:** HTTP scrape — `tournament.aspx?id=3` + Google Sheets `export?format=xlsx`
