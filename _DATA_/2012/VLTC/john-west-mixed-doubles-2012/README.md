# John West Mixed Doubles 2012

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2012
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=2](https://www.vltc.com.mt/tournament.aspx?id=2)
**Extraction method:** HTTP scrape — `tournament.aspx?id=2` + Google Sheets `export?format=xlsx`
