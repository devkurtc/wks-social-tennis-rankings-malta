# VLTC 40th Anniversary Tournament

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** unknown
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=30](https://www.vltc.com.mt/tournament.aspx?id=30)
**Extraction method:** HTTP scrape — `tournament.aspx?id=30` + Google Sheets `export?format=xlsx`
