# San Michel ITF Under 18

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** unknown
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=51](https://www.vltc.com.mt/tournament.aspx?id=51)
**Extraction method:** HTTP scrape — `tournament.aspx?id=51` + Google Sheets `export?format=xlsx`
