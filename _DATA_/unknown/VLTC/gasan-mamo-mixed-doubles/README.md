# Gasan Mamo Mixed Doubles

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** unknown
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=59](https://www.vltc.com.mt/tournament.aspx?id=59)
**Extraction method:** HTTP scrape — `tournament.aspx?id=59` + Google Sheets `export?format=xlsx`
