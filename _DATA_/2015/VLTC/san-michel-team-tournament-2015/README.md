# San Michel Team Tournament 2015

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2015
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=35](https://www.vltc.com.mt/tournament.aspx?id=35)
**Extraction method:** HTTP scrape — `tournament.aspx?id=35` + Google Sheets `export?format=xlsx`
