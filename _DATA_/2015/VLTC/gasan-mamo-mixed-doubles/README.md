...
**Year:** 2015
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=47](https://www.vltc.com.mt/tournament.aspx?id=47)
**Extraction method:** HTTP scrape — `tournament.aspx?id=47` + Google Sheets `export?format=xlsx`
