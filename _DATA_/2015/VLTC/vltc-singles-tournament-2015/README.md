# VLTC Singles tournament 2015

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2015
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=36](https://www.vltc.com.mt/tournament.aspx?id=36)
**Extraction method:** HTTP scrape — `tournament.aspx?id=36` + Google Sheets `export?format=xlsx`
