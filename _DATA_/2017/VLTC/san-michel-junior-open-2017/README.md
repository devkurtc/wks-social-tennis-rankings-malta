# San Michel Junior Open 2017

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2017
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=68](https://www.vltc.com.mt/tournament.aspx?id=68)
**Extraction method:** HTTP scrape — `tournament.aspx?id=68` + Google Sheets `export?format=xlsx`
