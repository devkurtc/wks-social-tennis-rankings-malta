# VLTC Tennis Europe U/14 Cat.3

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2017
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=67](https://www.vltc.com.mt/tournament.aspx?id=67)
**Extraction method:** HTTP scrape — `tournament.aspx?id=67` + Google Sheets `export?format=xlsx`
