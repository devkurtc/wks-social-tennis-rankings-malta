# San Michel Junior Open 2013

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2013
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=21](https://www.vltc.com.mt/tournament.aspx?id=21)
**Extraction method:** HTTP scrape — `tournament.aspx?id=21` + Google Sheets `export?format=xlsx`
