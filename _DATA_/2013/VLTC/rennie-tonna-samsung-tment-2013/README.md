# Rennie Tonna Samsung T'ment 2013

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2013
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=16](https://www.vltc.com.mt/tournament.aspx?id=16)
**Extraction method:** HTTP scrape — `tournament.aspx?id=16` + Google Sheets `export?format=xlsx`
