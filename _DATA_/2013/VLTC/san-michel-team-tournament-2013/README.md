# San Michel Team Tournament 2013

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2013
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=12](https://www.vltc.com.mt/tournament.aspx?id=12)
**Extraction method:** HTTP scrape — `tournament.aspx?id=12` + Google Sheets `export?format=xlsx`
