# Wilson Autumn Team Tournament 2013

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2013
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=20](https://www.vltc.com.mt/tournament.aspx?id=20)
**Extraction method:** HTTP scrape — `tournament.aspx?id=20` + Google Sheets `export?format=xlsx`
