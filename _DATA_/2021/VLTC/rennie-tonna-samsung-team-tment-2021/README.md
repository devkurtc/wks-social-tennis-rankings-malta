# Rennie Tonna Samsung Team T'ment 2021

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2021
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=103](https://www.vltc.com.mt/tournament.aspx?id=103)
**Extraction method:** HTTP scrape — `tournament.aspx?id=103` + Google Sheets `export?format=xlsx`
