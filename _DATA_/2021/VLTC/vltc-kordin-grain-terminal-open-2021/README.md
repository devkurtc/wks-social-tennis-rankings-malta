# VLTC Kordin Grain Terminal Open 2021

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2021
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=105](https://www.vltc.com.mt/tournament.aspx?id=105)
**Extraction method:** HTTP scrape — `tournament.aspx?id=105` + Google Sheets `export?format=xlsx`
