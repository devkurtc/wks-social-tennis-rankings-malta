# San Michel Junior Open 2021

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2021
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=104](https://www.vltc.com.mt/tournament.aspx?id=104)
**Extraction method:** HTTP scrape — `tournament.aspx?id=104` + Google Sheets `export?format=xlsx`
