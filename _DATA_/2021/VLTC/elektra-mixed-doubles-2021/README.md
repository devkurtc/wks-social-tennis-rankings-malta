# Elektra Mixed Doubles 2021

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2021
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=106](https://www.vltc.com.mt/tournament.aspx?id=106)
**Extraction method:** HTTP scrape — `tournament.aspx?id=106` + Google Sheets `export?format=xlsx`
