# Rennie Tonna Samsung Team T'ment 2018

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2018
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=76](https://www.vltc.com.mt/tournament.aspx?id=76)
**Extraction method:** HTTP scrape — `tournament.aspx?id=76` + Google Sheets `export?format=xlsx`
