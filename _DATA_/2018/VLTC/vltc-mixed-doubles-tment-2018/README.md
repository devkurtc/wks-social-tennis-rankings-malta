# VLTC Mixed Doubles T'ment 2018

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2018
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=78](https://www.vltc.com.mt/tournament.aspx?id=78)
**Extraction method:** HTTP scrape — `tournament.aspx?id=78` + Google Sheets `export?format=xlsx`
