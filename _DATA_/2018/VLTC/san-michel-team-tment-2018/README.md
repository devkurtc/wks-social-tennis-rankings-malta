# San Michel Team T'ment 2018

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2018
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=72](https://www.vltc.com.mt/tournament.aspx?id=72)
**Extraction method:** HTTP scrape — `tournament.aspx?id=72` + Google Sheets `export?format=xlsx`
