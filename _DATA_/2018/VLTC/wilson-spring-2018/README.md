...
**Year:** 2018
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=74](https://www.vltc.com.mt/tournament.aspx?id=74)
**Extraction method:** HTTP scrape — `tournament.aspx?id=74` + Google Sheets `export?format=xlsx`
