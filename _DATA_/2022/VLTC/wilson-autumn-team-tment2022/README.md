# Wilson Autumn Team T'ment2022

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2022
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=117](https://www.vltc.com.mt/tournament.aspx?id=117)
**Extraction method:** HTTP scrape — `tournament.aspx?id=117` + Google Sheets `export?format=xlsx`
**Last extracted:** 2026-04-26 06:56 UTC

## Files in this folder

- `Wilson Autumn Team T'ment2022.xlsx` (Google Sheet ID `1nQ4A-FoTY7Gq-ocnkjcWcHhJ6R2z0-CK`, sha256 `b7f98fceab6b…`)
