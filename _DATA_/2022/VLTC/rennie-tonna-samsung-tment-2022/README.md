# Rennie Tonna Samsung T'ment 2022

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2022
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=114](https://www.vltc.com.mt/tournament.aspx?id=114)
**Extraction method:** HTTP scrape — `tournament.aspx?id=114` + Google Sheets `export?format=xlsx`
**Last extracted:** 2026-04-26 06:56 UTC

## Files in this folder

- `Rennie Tonna Samsung T'ment 2022.xlsx` (Google Sheet ID `10ZfeIeVUKsOPmM6ikLnrNEmTf5tW08gX`, sha256 `…`)
