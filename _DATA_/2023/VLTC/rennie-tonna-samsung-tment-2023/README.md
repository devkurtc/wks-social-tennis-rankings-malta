# Rennie Tonna Samsung T'ment 2023

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2023
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=126](https://www.vltc.com.mt/tournament.aspx?id=126)
**Extraction method:** HTTP scrape — `tournament.aspx?id=126` + Google Sheets `export?format=xlsx`
**Last extracted:** 2026-04-26 06:56 UTC

## Files in this folder

- `Rennie Tonna Samsung T'ment 2023.xlsx` (Google Sheet ID `1AnpYVZIJniw4W3IgPsbHzyVISeZDXWRO`, sha256 `a27697c4f7ab…`)
