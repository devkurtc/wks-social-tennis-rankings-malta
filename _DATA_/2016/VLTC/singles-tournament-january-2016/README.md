# Singles Tournament January 2016

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2016
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=50](https://www.vltc.com.mt/tournament.aspx?id=50)
**Extraction method:** HTTP scrape — `tournament.aspx?id=50` + Google Sheets `export?format=xlsx`
