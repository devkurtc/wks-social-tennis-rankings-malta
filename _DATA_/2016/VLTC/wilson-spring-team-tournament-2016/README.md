# Wilson Spring Team Tournament 2016

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2016
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=52](https://www.vltc.com.mt/tournament.aspx?id=52)
**Extraction method:** HTTP scrape — `tournament.aspx?id=52` + Google Sheets `export?format=xlsx`
