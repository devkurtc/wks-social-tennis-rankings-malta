# Rennie Tonna Samsung Team T'ment 2016

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2016
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=55](https://www.vltc.com.mt/tournament.aspx?id=55)
**Extraction method:** HTTP scrape — `tournament.aspx?id=55` + Google Sheets `export?format=xlsx`
