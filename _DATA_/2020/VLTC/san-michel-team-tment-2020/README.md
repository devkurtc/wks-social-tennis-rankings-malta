# San Michel Team T'ment 2020

**Club:** Vittoriosa Lawn Tennis Club (VLTC), Malta
**Year:** 2020
**Source:** Club website
**Source URL:** [https://www.vltc.com.mt/tournament.aspx?id=93](https://www.vltc.com.mt/tournament.aspx?id=93)
**Extraction method:** HTTP scrape — `tournament.aspx?id=93` + Google Sheets `export?format=xlsx`
